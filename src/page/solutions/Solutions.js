            ...
            <div className={CSS.box_container}>
               <div className={`${CSS.box1} ${CSS.box}`}>
                  ...
                  <div className={`${CSS.box_content_container}`}>
                     ...
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {website.section1.subtitle4}
                     </h4>
                     <p className={`${CSS.box_conntent_text} `}>
                        {website.section1.description4}
                     </p>
                  </div>
               </div>
               <div className={`${CSS.box2} ${CSS.box}`}>
                  ...
                  <div className={`${CSS.box_content_container}`}>
                     ...
                     <p className={`${CSS.box_conntent_text}`}>
                        {website.section2.description3}
                     </p>
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {website.section2.subtitle4}
                     </h4>
                     <p className={`${CSS.box_conntent_text}`}>
                        {website.section2.description4}
                     </p>
                  </div>
               </div>
               <div className={`${CSS.box3} ${CSS.box}`}>
            ...
            <div className={CSS.box_container}>
               <div className={`${CSS.box1} ${CSS.box} ${CSS.hotel_container}`}>
                  ...
                  <div className={`${CSS.box_content_container}`}>
                     ...
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {custom.section1.subtitle4}
                     </h4>
                     <p className={`${CSS.box_conntent_text} `}>
                        {custom.section1.description4}
                     </p>
                  </div>
               </div>
               <div className={`${CSS.box2} ${CSS.box} ${CSS.shop_container}`}>
                  ...
                  <div className={`${CSS.box_content_container}`}>
                     ...
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {custom.section2.subtitle3}
                     </h4>
                     <p className={`${CSS.box_conntent_text}`}>
                        {custom.section2.description3}
                     </p>
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {custom.section2.subtitle4}
                     </h4>
                     <p className={`${CSS.box_conntent_text}`}>
                        {custom.section2.description4}
                     </p>
                  </div>
               </div>
               <div className={`${CSS.box3} ${CSS.box} `}>
                  ...
                  <div className={`${CSS.box_content_container}`}>
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {custom.section3.subtitle1}
                     </h4>
                     <p className={`${CSS.box_conntent_text}`}>
                        {custom.section3.description1}
                     </p>
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {custom.section3.subtitle2}
                     </h4>
                     <p className={`${CSS.box_conntent_text}`}>
                        {custom.section3.description2}
                     </p>
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {custom.section3.subtitle3}
                     </h4>
                     <p className={`${CSS.box_conntent_text}`}>
                        {custom.section3.description3}
                     </p>
                     <h4 className={`${CSS.box_content_title} primary`}>
                        {custom.section3.subtitle4}
                     </h4>
                     <p className={`${CSS.box_conntent_text}`}>
                        {custom.section3.description4}
                     </p>
                  </div>
               </div>
               <div className={`${CSS.box4} ${CSS.box}`}>
